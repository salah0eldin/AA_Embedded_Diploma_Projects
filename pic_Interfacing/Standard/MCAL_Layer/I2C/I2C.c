    ...
    if (NULL == _i2c) {
        ...
        switch (_i2c->i2c_mode) {
            case I2C_MASTER_DEFINED_CLOCK:
                ...
                break;
            case I2C_MASTER_FIRMWARE_CONTROLLED: I2C_MODE_SELECT(I2C_MASTER_FIRMWARE_CONTROLLED);
                break;
            default: ret = E_NOT_OK;
                break;
        }
        // General call enable/disable
        if (I2C_GENERAL_CALL_ENABLE_CFG == _i2c->i2c_slave_general_call_control) {
...
static Std_ReturnType inline I2C_Slave_Mode_Select(const I2C_t *_i2c) {
    Std_ReturnType ret = E_OK;
    switch (_i2c->i2c_mode) {
        case I2C_SLAVE_7BITS_ADD: I2C_MODE_SELECT(I2C_SLAVE_7BITS_ADD);
            break;
        case I2C_SLAVE_10BITS_ADD: I2C_MODE_SELECT(I2C_SLAVE_10BITS_ADD);
            break;
        case I2C_SLAVE_7BITS_ADD_S_P_ENABLED: I2C_MODE_SELECT(I2C_SLAVE_7BITS_ADD_S_P_ENABLED);
            break;
        case I2C_SLAVE_10BITS_ADD_S_P_ENABLED: I2C_MODE_SELECT(I2C_SLAVE_10BITS_ADD_S_P_ENABLED);
            break;
        default: ret = E_NOT_OK;
            break;
    }
