...
# 21 "./APP/../ECU_Layer/LED/../../MCAL_Layer/GPIO/gpio.h"
...
# 23 "./APP/../ECU_Layer/LED/../../MCAL_Layer/GPIO/gpio.h" 2
# 53 "./APP/../ECU_Layer/LED/../../MCAL_Layer/GPIO/gpio.h"
typedef enum
{
    GPIO_LOW = 0,
    GPIO_HIGH
...
typedef struct
{
    ...
    void (* TIMR0_InterruptHandler)(void);
...
# 54 "./MCAL_Layer/Timers/timer2.h"
typedef struct
{

    void (* TIMR2_InterruptHandler)(void);
