...
# 18 "ECU_Layer/Chr_LCD/../../MCAL_Layer/GPIO/gpio.h"
...
# 18 "ECU_Layer/Chr_LCD/../../MCAL_Layer/GPIO/gpio.h" 2

# 1 "ECU_Layer/Chr_LCD/../../MCAL_Layer/GPIO/../std_types.h" 1
# 14 "ECU_Layer/Chr_LCD/../../MCAL_Layer/GPIO/../std_types.h"
...
# 15 "ECU_Layer/Chr_LCD/../../MCAL_Layer/GPIO/../std_types.h" 2
# 44 "ECU_Layer/Chr_LCD/../../MCAL_Layer/GPIO/../std_types.h"
...
# 19 "ECU_Layer/Chr_LCD/../../MCAL_Layer/GPIO/gpio.h" 2

# 1 "ECU_Layer/Chr_LCD/../../MCAL_Layer/GPIO/../device_config.h" 1
# 20 "ECU_Layer/Chr_LCD/../../MCAL_Layer/GPIO/gpio.h" 2
# 44 "ECU_Layer/Chr_LCD/../../MCAL_Layer/GPIO/gpio.h"
typedef enum
{
    GPIO_LOW = 0,
    GPIO_HIGH
...
# 59 "ECU_Layer/Chr_LCD/chr_lcd.h"
...
# 30 "ECU_Layer/Chr_LCD/chr_lcd.c"
Std_ReturnType lcd_4bit_init(lcd_4bit_t *lcd) {
    ...
    if (((void*)0) == lcd) {
        ...
        ret = lcd_4bit_send_cmd(lcd, 0x38);
        _delay((unsigned long)((5)*(4000000UL/4000.0)));
        ret = lcd_4bit_send_cmd(lcd, 0x38);
        _delay((unsigned long)((120)*(4000000UL/4000000.0)));
        ret = lcd_4bit_send_cmd(lcd, 0x38);

        ret = lcd_4bit_send_cmd(lcd, 0x01);
        _delay((unsigned long)((1)*(4000000UL/4000.0)));
        ret = lcd_4bit_send_cmd(lcd, 0x02);
        ret = lcd_4bit_send_cmd(lcd, 0x06);
        ret = lcd_4bit_send_cmd(lcd, 0x0C);
        ret = lcd_4bit_send_cmd(lcd, 0x28);
...
Std_ReturnType lcd_4bit_send_custom_char(const lcd_4bit_t *lcd, const uint8 chr[],
    ...
    if (((void*)0) == lcd) {
        ...
        ret = lcd_4bit_send_cmd(lcd, 0x40 + (mem_pos * 8));
