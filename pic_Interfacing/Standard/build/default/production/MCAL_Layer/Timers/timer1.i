...
# 11 "MCAL_Layer/Timers/timer1.c"
# 1 "MCAL_Layer/Timers/timer1.h" 1
# 14 "MCAL_Layer/Timers/timer1.h"
...
# 15 "MCAL_Layer/Timers/timer1.h" 2
...
# 16 "MCAL_Layer/Timers/timer1.h" 2
...
# 12 "MCAL_Layer/Timers/timer1.c" 2





static void (*TIMR1_InterruptHandler)(void) = ((void*)0);


static uint16 preload = 0;

static __attribute__((inline)) void Timer1_Mode_Select(const timer1_t *timer);
static __attribute__((inline)) void Timer1_RW_Mode_Select(const timer1_t *timer);
static __attribute__((inline)) void Timer1_Osc_Config(const timer1_t *timer);
# 38 "MCAL_Layer/Timers/timer1.c"
Std_ReturnType Timer1_Init(const timer1_t *timer) {
...
# 122 "MCAL_Layer/Timers/timer1.c"
Std_ReturnType Timer1_Write_Value(const timer1_t *timer, uint16 val) {
    Std_ReturnType ret = 0x01;
...
# 143 "MCAL_Layer/Timers/timer1.c"
Std_ReturnType Timer1_Read(const timer1_t *timer, uint16 *val) {
    Std_ReturnType ret = 0x01;
...
# 166 "MCAL_Layer/Timers/timer1.c"
static __attribute__((inline)) void Timer1_Mode_Select(const timer1_t *timer) {
    if (0 == timer->mode) {
        (T1CONbits.TMR1CS = 0);
    } else if (1 == timer->mode) {
        (T1CONbits.TMR1CS = 1);
        if (0 == timer->counter_sync) {
            (T1CONbits.T1SYNC = 0);
        } else if (1 == timer->counter_sync) {
            (T1CONbits.T1SYNC = 1);
        } else {
...
static __attribute__((inline)) void Timer1_Osc_Config(const timer1_t *timer) {
    if (1 == timer->osc_enable) {
        (T1CONbits.T1OSCEN = 1);
    } else if (0 == timer->osc_enable) {
        (T1CONbits.T1OSCEN = 0);
    } else {

    }
}
# 221 "MCAL_Layer/Timers/timer1.c"
void TIMR1_ISR(void) {
