...
# 11 "MCAL_Layer/USART/usart.c"
# 1 "MCAL_Layer/USART/usart.h" 1
# 14 "MCAL_Layer/USART/usart.h"
# 1 "MCAL_Layer/USART/usart_cfg.h" 1
# 15 "MCAL_Layer/USART/usart.h" 2
# 1 "MCAL_Layer/USART/../GPIO/gpio.h" 1
# 21 "MCAL_Layer/USART/../GPIO/gpio.h"
...
# 21 "MCAL_Layer/USART/../GPIO/gpio.h" 2

# 1 "MCAL_Layer/USART/../GPIO/../std_types.h" 1
# 14 "MCAL_Layer/USART/../GPIO/../std_types.h"
# 1 "MCAL_Layer/USART/../GPIO/../compiler.h" 1
# 14 "MCAL_Layer/USART/../GPIO/../std_types.h" 2

# 1 "MCAL_Layer/USART/../GPIO/../std_libraries.h" 1
# 14 "MCAL_Layer/USART/../GPIO/../std_libraries.h"
...
# 16 "MCAL_Layer/USART/../GPIO/../std_libraries.h" 2
# 15 "MCAL_Layer/USART/../GPIO/../std_types.h" 2
# 44 "MCAL_Layer/USART/../GPIO/../std_types.h"
...
# 22 "MCAL_Layer/USART/../GPIO/gpio.h" 2

# 1 "MCAL_Layer/USART/../GPIO/../device_config.h" 1
# 23 "MCAL_Layer/USART/../GPIO/gpio.h" 2
# 53 "MCAL_Layer/USART/../GPIO/gpio.h"
typedef enum
{
    GPIO_LOW = 0,
    GPIO_HIGH
...
# 14 "MCAL_Layer/USART/../interrupt/internal_interrupt.h"
# 1 "MCAL_Layer/USART/../interrupt/interrupt_config.h" 1
# 14 "MCAL_Layer/USART/../interrupt/interrupt_config.h"
# 1 "MCAL_Layer/USART/../interrupt/interrupt_gen_config.h" 1
# 15 "MCAL_Layer/USART/../interrupt/interrupt_config.h" 2
# 62 "MCAL_Layer/USART/../interrupt/interrupt_config.h"
typedef enum
{
    INTERRUPT_LOW_PRIORITY = 0,
    INTERRUPT_HIGH_PRIORITY,
}interrupt_priority;
# 15 "MCAL_Layer/USART/../interrupt/internal_interrupt.h" 2
# 17 "MCAL_Layer/USART/usart.h" 2
# 68 "MCAL_Layer/USART/usart.h"
typedef enum
{
...
static __attribute__((inline)) void Eusart_Baudrate_Calc(const usart_t *_usart);
static __attribute__((inline)) void Eusart_Async_Tx_Init(const usart_t *_usart);
static __attribute__((inline)) void Eusart_Async_Rx_Init(const usart_t *_usart);
static __attribute__((inline)) void Eusart_Async_Rx_Restart(void);
# 44 "MCAL_Layer/USART/usart.c"
Std_ReturnType Eusart_Async_Init(const usart_t *_usart)
{
...
# 246 "MCAL_Layer/USART/usart.c"
static __attribute__((inline)) void Eusart_Baudrate_Calc(const usart_t *_usart)
{
    float32 baudrate_reg_bits = 0;
    ...
    if(EUSART_ASYNC_8BITS_HIGH_SPEED_BAUDRATE == _usart->baudrate_generator)
    {
        ...
        baudrate_reg_bits = (8000000UL/(float32)(16*_usart->baudrate)) - 1;
    }
    else if (EUSART_ASYNC_8BITS_LOW_SPEED_BAUDRATE == _usart->baudrate_generator)
    {
        ...
        baudrate_reg_bits = (8000000UL/(float32)(64*_usart->baudrate)) - 1;
    }
    else if (EUSART_ASYNC_16BITS_HIGH_SPEED_BAUDRATE == _usart->baudrate_generator)
    {
        ...
        baudrate_reg_bits = (8000000UL/(float32)(4*_usart->baudrate)) - 1;
    }
...
static __attribute__((inline)) void Eusart_Async_Tx_Init(const usart_t *_usart)
{
    ...
    if(1 == _usart->tx_cfg.usart_tx_interrupt_enable)
    {

        (PIE1bits.TXIE = 1);
        EUSART_TXInterruptHandler = _usart->EUSART_TXInterruptHandler;
# 344 "MCAL_Layer/USART/usart.c"
        (INTCONbits.GIE = 1);
        (INTCONbits.PEIE = 1);

    }
    else if(0 == _usart->tx_cfg.usart_tx_interrupt_enable)
    {
        (PIE1bits.TXIE = 0);
    }
    else{ }
...
static __attribute__((inline)) void Eusart_Async_Rx_Init(const usart_t *_usart)
{
    ...
    if(1 == _usart->rx_cfg.usart_rx_interrupt_enable)
    {

        (PIE1bits.RCIE = 1);
        EUSART_RXInterruptHandler = _usart->EUSART_RXInterruptHandler;
        EUSART_FramingErrorHandler = _usart->EUSART_FramingErrorHandler;
# 387 "MCAL_Layer/USART/usart.c"
        (INTCONbits.GIE = 1);
        (INTCONbits.PEIE = 1);

    }
    else if(0 == _usart->rx_cfg.usart_rx_interrupt_enable)
    {
        (PIE1bits.RCIE = 0);
    }
    else{ }
