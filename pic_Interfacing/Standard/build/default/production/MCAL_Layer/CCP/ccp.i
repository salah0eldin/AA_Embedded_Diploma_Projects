...
# 16 "MCAL_Layer/CCP/../GPIO/../std_libraries.h" 2
# 15 "MCAL_Layer/CCP/../GPIO/../std_types.h" 2
# 44 "MCAL_Layer/CCP/../GPIO/../std_types.h"
...
# 22 "MCAL_Layer/CCP/../GPIO/gpio.h" 2

# 1 "MCAL_Layer/CCP/../GPIO/../device_config.h" 1
# 23 "MCAL_Layer/CCP/../GPIO/gpio.h" 2
# 53 "MCAL_Layer/CCP/../GPIO/gpio.h"
typedef enum
{
    GPIO_LOW = 0,
    GPIO_HIGH
...
# 14 "MCAL_Layer/CCP/../Interrupt/internal_interrupt.h"
# 1 "MCAL_Layer/CCP/../Interrupt/interrupt_config.h" 1
# 14 "MCAL_Layer/CCP/../Interrupt/interrupt_config.h"
# 1 "MCAL_Layer/CCP/../Interrupt/interrupt_gen_config.h" 1
# 15 "MCAL_Layer/CCP/../Interrupt/interrupt_config.h" 2
# 62 "MCAL_Layer/CCP/../Interrupt/interrupt_config.h"
typedef enum
{
    INTERRUPT_LOW_PRIORITY = 0,
    INTERRUPT_HIGH_PRIORITY,
}interrupt_priority;
# 15 "MCAL_Layer/CCP/../Interrupt/internal_interrupt.h" 2
...
static void __attribute__((inline)) CCP_Interrupt_Config(const ccp_t *_ccp);
static void __attribute__((inline)) CCP_Mode_Timer_Select(const ccp_t *_ccp);
static Std_ReturnType __attribute__((inline)) CCP_Capture_Config(const ccp_t *_ccp);
static Std_ReturnType __attribute__((inline)) CCP_Compare_Config(const ccp_t *_ccp);
# 41 "MCAL_Layer/CCP/ccp.c"
Std_ReturnType CCP_Init(const ccp_t *_ccp) {
    ...
    if (((void*)0) == _ccp) {
        ...
        else if (CCP_PWM_MD == _ccp->mode) {

            PR2 = (uint8) ((8000000UL / (_ccp->PWM_Freq * 4.0 * _ccp->timer2_postscaler
...
static Std_ReturnType __attribute__((inline)) CCP_Capture_Config(const ccp_t *_ccp) {
    ...
    if (CCP1_INST == _ccp->CCPx) {
        ...
        switch (_ccp->mode_variant) {
            case 0x04: (CCP1CONbits.CCP1M = 0x04);
                break;
            case 0x05: (CCP1CONbits.CCP1M = 0x05);
                break;
            case 0x06: (CCP1CONbits.CCP1M = 0x06);
                break;
            case 0x07: (CCP1CONbits.CCP1M = 0x07);
                break;
            default: ret = 0x00;
                break;
        }
        ...
        switch (_ccp->mode_variant) {
            case 0x04: (CCP2CONbits.CCP2M = 0x04);
                break;
            case 0x05: (CCP2CONbits.CCP2M = 0x05);
                break;
            case 0x06: (CCP2CONbits.CCP2M = 0x06);
                break;
            case 0x07: (CCP2CONbits.CCP2M = 0x07);
                break;
            default: ret = 0x00;
                break;
        }
...
static Std_ReturnType __attribute__((inline)) CCP_Compare_Config(const ccp_t *_ccp) {
    ...
    if (CCP1_INST == _ccp->CCPx) {
        ...
        switch (_ccp->mode_variant) {
            case 0x02: (CCP1CONbits.CCP1M = 0x02);
                break;
            case 0x09: (CCP1CONbits.CCP1M = 0x09);
                break;
            case 0x08: (CCP1CONbits.CCP1M = 0x08);
                break;
            case 0x0A: (CCP1CONbits.CCP1M = 0x0A);
                break;
            case 0x0B: (CCP1CONbits.CCP1M = 0x0B);
                break;
            default: ret = 0x00;
                break;
        }
        ...
        switch (_ccp->mode_variant) {
            case 0x02: (CCP2CONbits.CCP2M = 0x02);
                break;
            case 0x09: (CCP2CONbits.CCP2M = 0x09);
                break;
            case 0x08: (CCP2CONbits.CCP2M = 0x08);
                break;
            case 0x0A: (CCP2CONbits.CCP2M = 0x0A);
                break;
            case 0x0B: (CCP2CONbits.CCP2M = 0x0B);
                break;
            default: ret = 0x00;
                break;
        }
