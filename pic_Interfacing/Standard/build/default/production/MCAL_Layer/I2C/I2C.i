...
# 15 "MCAL_Layer/I2C/../GPIO/../std_types.h" 2
# 44 "MCAL_Layer/I2C/../GPIO/../std_types.h"
...
# 22 "MCAL_Layer/I2C/../GPIO/gpio.h" 2

# 1 "MCAL_Layer/I2C/../GPIO/../device_config.h" 1
# 23 "MCAL_Layer/I2C/../GPIO/gpio.h" 2
# 53 "MCAL_Layer/I2C/../GPIO/gpio.h"
typedef enum
{
    GPIO_LOW = 0,
    GPIO_HIGH
...
# 14 "MCAL_Layer/I2C/../interrupt/internal_interrupt.h"
# 1 "MCAL_Layer/I2C/../interrupt/interrupt_config.h" 1
# 14 "MCAL_Layer/I2C/../interrupt/interrupt_config.h"
# 1 "MCAL_Layer/I2C/../interrupt/interrupt_gen_config.h" 1
# 15 "MCAL_Layer/I2C/../interrupt/interrupt_config.h" 2
# 62 "MCAL_Layer/I2C/../interrupt/interrupt_config.h"
typedef enum
{
    INTERRUPT_LOW_PRIORITY = 0,
    INTERRUPT_HIGH_PRIORITY,
}interrupt_priority;
# 15 "MCAL_Layer/I2C/../interrupt/internal_interrupt.h" 2
# 17 "MCAL_Layer/I2C/I2C.h" 2
# 134 "MCAL_Layer/I2C/I2C.h"
typedef enum
{
...
static void (*I2C_Interrupt_Write_Col)(void) = ((void*)0);


static void __attribute__((inline)) I2C_Gpio_Configurations();
static void __attribute__((inline)) I2C_Interrupt_Configure(const I2C_t *_i2c);
static Std_ReturnType __attribute__((inline)) I2C_Slave_Mode_Select(const I2C_t *_i2c);
# 40 "MCAL_Layer/I2C/I2C.c"
Std_ReturnType I2C_Master_Init(const I2C_t *_i2c) {
    ...
    if (((void*)0) == _i2c) {
        ...
        switch (_i2c->i2c_mode) {
            case I2C_MASTER_DEFINED_CLOCK:
                (SSPCON1bits.SSPM = I2C_MASTER_DEFINED_CLOCK);
                SSPADD = (uint8) ((8000000UL / (4 * (_i2c->i2c_clock_freq))) - 1);
                break;
            case I2C_MASTER_FIRMWARE_CONTROLLED: (SSPCON1bits.SSPM = I2C_MASTER_FIRMWARE_CONTROLLED);
                break;
            default: ret = 0x00;
                break;
        }

        if (1 == _i2c->i2c_slave_general_call_control) {
            (SSPCON2bits.GCEN = 1);
        } else {
            (SSPCON2bits.GCEN = 0);
        }

        if (1 == _i2c->master_rec_mode_status) {
            (SSPCON2bits.RCEN = 1);
        } else {
            (SSPCON2bits.RCEN = 0);
        }
...
Std_ReturnType I2C_Slave_Init(const I2C_t *_i2c) {
    ...
    if (((void*)0) == _i2c) {
        ...
        if (1 == _i2c->i2c_slave_clk_stretching_control) {
            (SSPCON2bits.SEN = 1);
...
Std_ReturnType I2C_Slave_Transmit(const uint8 data, uint8 *_ack) {
    ...
    if (((void*)0) == _ack) {
        ret = 0x00;
    } else if (1 == (SSPSTATbits.R_W) && 0 == (SSPSTATbits.D_nA)) {
        dummy_data = SSPBUF;
        SSPBUF = data;
        (SSPCON1bits.CKP = 1);
        if ((SSPCON1bits.WCOL) == 1) {
...
# 364 "MCAL_Layer/I2C/I2C.c"
Std_ReturnType I2C_Slave_Recieve(uint8 *rec_data) {
    Std_ReturnType ret = 0x01;
    uint8 dummy_data = 0;

    if (((void*)0) != rec_data && 0 == (SSPSTATbits.D_nA) &&
            0 == (SSPSTATbits.R_W)) {
        dummy_data = SSPBUF;
        while (!(SSPSTATbits.BF));
        PIR1bits.SSPIF = 0;
...
# 416 "MCAL_Layer/I2C/I2C.c"
static Std_ReturnType __attribute__((inline)) I2C_Slave_Mode_Select(const I2C_t *_i2c) {
    Std_ReturnType ret = 0x01;
    switch (_i2c->i2c_mode) {
        case I2C_SLAVE_7BITS_ADD: (SSPCON1bits.SSPM = I2C_SLAVE_7BITS_ADD);
            break;
        case I2C_SLAVE_10BITS_ADD: (SSPCON1bits.SSPM = I2C_SLAVE_10BITS_ADD);
            break;
        case I2C_SLAVE_7BITS_ADD_S_P_ENABLED: (SSPCON1bits.SSPM = I2C_SLAVE_7BITS_ADD_S_P_ENABLED);
            break;
        case I2C_SLAVE_10BITS_ADD_S_P_ENABLED: (SSPCON1bits.SSPM = I2C_SLAVE_10BITS_ADD_S_P_ENABLED);
            break;
        default: ret = 0x00;
            break;
    }
...
static void __attribute__((inline)) I2C_Gpio_Configurations() {
    ...
    TRISCbits.RC4 = GPIO_DIRECTION_INPUT;
}
# 486 "MCAL_Layer/I2C/I2C.c"
void I2C_ISR() {
