...
# 1 "./mcc_generated_files/system/../i2c_client/mssp.h" 1
# 39 "./mcc_generated_files/system/../i2c_client/mssp.h"
...
# 47 "./mcc_generated_files/system/../i2c_client/i2c_client_interface.h" 2
...
# 39 "./mcc_generated_files/system/../i2c_client/mssp.h" 2
# 61 "./mcc_generated_files/system/../i2c_client/mssp.h"
extern const struct I2C_CLIENT_INTERFACE I2C1_Client;
# 71 "./mcc_generated_files/system/../i2c_client/mssp.h"
void I2C1_Initialize(void);
# 80 "./mcc_generated_files/system/../i2c_client/mssp.h"
void I2C1_Deinitialize(void);
# 89 "./mcc_generated_files/system/../i2c_client/mssp.h"
void I2C1_WriteByte(uint8_t wrByte);
# 98 "./mcc_generated_files/system/../i2c_client/mssp.h"
uint8_t I2C1_ReadByte(void);
# 107 "./mcc_generated_files/system/../i2c_client/mssp.h"
uint16_t I2C1_ReadAddr(void);
# 120 "./mcc_generated_files/system/../i2c_client/mssp.h"
i2c_client_error_t I2C1_ErrorGet(void);
# 131 "./mcc_generated_files/system/../i2c_client/mssp.h"
i2c_client_transfer_dir_t I2C1_TransferDirGet(void);
# 142 "./mcc_generated_files/system/../i2c_client/mssp.h"
i2c_client_ack_status_t I2C1_LastByteAckStatusGet(void);
# 151 "./mcc_generated_files/system/../i2c_client/mssp.h"
void I2C1_CallbackRegister(_Bool (*callback)(i2c_client_transfer_event_t clientEvent));
# 160 "./mcc_generated_files/system/../i2c_client/mssp.h"
void I2C1_ISR(void);
# 169 "./mcc_generated_files/system/../i2c_client/mssp.h"
...
volatile uint8_t i2c_interrupt_counter = 0;
...
_Bool I2C_InterruptHandler(i2c_client_transfer_event_t clientEvent) {
        ...
        if (i2c_interrupt_counter) {
            ...
            switch (i2c_received_data) {
                case temp_state_idle:
                    CCP2_LoadDutyValue((155.5 * 4 * 0.5));
                    break;
                case temp_state_high:
                    CCP2_LoadDutyValue((155.5 * 4 * 0.75));
                    break;
                case temp_state_max:
                    CCP2_LoadDutyValue((155.5 * 4));
